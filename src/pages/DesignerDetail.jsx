  ...
  useEffect(() => {
    ...
    const designerData = {
      1: {
        ...
        career: "경력 8년",
        introduction:
          "안녕하세요. 고객님의 개성과 라이프스타일을 고려한 맞춤형 스타일링을 제안해드립니다.",
        reviews: [
          {
            id: 1,
            rating: 5,
            comment: "정말 친절하고 전문적인 상담이었어요!",
            date: "2024-03-15",
          },
          {
            id: 2,
            rating: 5,
            comment: "꼼꼼하게 설명해주셔서 좋았습니다.",
            date: "2024-03-10",
          },
        ],
      },
      2: {
        ...
        career: "경력 10년",
        introduction:
          "트렌디한 스타일과 건강한 모발을 동시에 추구합니다.",
        reviews: [
          {
            id: 1,
            rating: 5,
            comment: "친절하고 세세하게 설명해주셨어요",
            date: "2024-03-14",
          },
          {
            id: 2,
            rating: 4,
            comment: "만족스러운 상담이었습니다",
            date: "2024-03-12",
          },
        ],
      },
      3: {
        ...
        type: ["대면"],
        description:
          "차별화 된 탈색 & 염색 노하우 기법, 꼼꼼한 컨설팅",
        image: "https://via.placeholder.com/150",
        rating: 5.0,
        reviewCount: 189,
        career: "경력 12년",
        introduction:
          "건강한 두피, 모발을 위한 맞춤형 시술을 제안합니다.",
        reviews: [
          {
            id: 1,
            rating: 5,
      ...
      5: {
        ...
        career: "경력 5년",
        introduction:
          "고객님의 피부톤과 이미지에 맞는 최적의 컬러를 찾아드립니다.",
        reviews: [
          {
            id: 1,
            rating: 5,
            comment: "컬러 추천이 너무 좋았어요",
            date: "2024-03-14",
          },
        ],
      },
      6: {
        ...
        career: "경력 7년",
        introduction:
          "자연스러운 스타일링으로 일상 속 특별함을 선사합니다.",
        reviews: [
          {
            id: 1,
            rating: 5,
            comment: "편안한 분위기에서 상담받았어요",
            date: "2024-03-13",
          },
        ],
      },
      ...
      8: {
        ...
        career: "경력 8년",
        introduction:
          "섬세한 상담으로 원하시는 스타일을 정확히 파악합니다.",
        reviews: [
          {
            id: 1,
            rating: 5,
            comment: "상세한 설명이 좋았어요",
            date: "2024-03-11",
          },
        ],
      },
      9: {
        ...
        career: "경력 5년",
        introduction:
          "섬세한 컬러 매칭으로 새로운 이미지를 찾아드립니다.",
        reviews: [
          {
            id: 1,
            rating: 5,
            comment: "컬러 매칭이 정말 좋았어요",
            date: "2024-03-10",
          },
        ],
      },
      ...
      12: {
        ...
        career: "경력 13년",
        introduction:
          "단발 스타일의 다양한 변형으로 새로운 매력을 찾아드립니다.",
        reviews: [
          {
            id: 1,
            rating: 5,
            comment: "단발 스타일링 최고예요!",
            date: "2024-03-13",
          },
        ],
      },
      13: {
        ...
        career: "경력 6년",
        introduction:
          "일상생활에서 쉽게 연출할 수 있는 스타일을 제안합니다.",
        reviews: [
          {
            id: 1,
            rating: 5,
            comment: "관리하기 쉬운 스타일 추천받았어요",
            date: "2024-03-12",
          },
        ],
      },
      14: {
        ...
        career: "경력 10년",
        introduction:
          "자연스러운 웨이브로 일상의 스타일을 업그레이드합니다.",
        reviews: [
          {
            id: 1,
            rating: 5,
            comment: "자연스러운 스타일링이 정말 좋아요",
            date: "2024-03-11",
          },
        ],
      },
      15: {
        ...
        career: "경력 7년",
        introduction:
          "퍼스널 컬러를 기반으로 한 맞춤형 컬러 제안을 해드립니다.",
        reviews: [
          {
            id: 1,
            rating: 5,
            comment: "제 퍼스널 컬러에 딱 맞는 추천받았어요",
            date: "2024-03-10",
          },
        ],
      },
